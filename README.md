...
### 📊 Main Dashboard
*Beautiful retro-futuristic glassmorphism interface with real-time analytics*

![Dashboard Overview](data/dashboard_demgraph.png)
...
3. **Add the dataset**
   - Download `adult.data.csv` from UCI ML Repository (if not already exist)
...
├── Inside
│   ├── demographic_data_analyzer.py          # Main Analysis
│   ├── main.py
│   └── test_module.py
├── data
